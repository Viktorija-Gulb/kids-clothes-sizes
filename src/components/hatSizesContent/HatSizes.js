...
import HatSizesTable from "../hatsTable/HatSizesTable";
    ...
    <section className="section">
      <div className="section__wrapper" id="hats-table">
        ...
        <p className="paragraph">
          Šie dydžiai yra orientaciniai, kiekvieno vaiko galvytė gali skirtis,
          todėl svarbu pasimatuoti galvytės apimtį.
        </p>
      </div>
    </section>
  );
