...
import ShoesSizesTable from "../shoesTable/ShoesSizesTable";
    ...
    <section className="section">
      <div className="section__wrapper" id="shoes-table">
        ...
        <p className="paragraph">
          Prieš rinkdamiesi avalynę pamatuokite vaiko pedutę. Vienas iš variantų
          pastatyti vaiko koją ant poperiaus lapo ir apibrėžti. Taip galėsite
          lengviau išmatuoti jau ant popiepieriaus.
        </p>
